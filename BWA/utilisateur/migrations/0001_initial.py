    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('restaurateur', 'Restaurateur'), ('client', 'Client')], default='client', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='utilisateur.user')),
            ],
        ),
        migrations.CreateModel(
            name='ClientProfile',
